 ...
 */
#define DISTRHO_PLUGIN_NAME "ImGuiDemo"
...
/**
   ...
   @note This macro is required.
 */
#define DISTRHO_PLUGIN_URI "urn:distrho:examples:imguisdemo"
...
*/
#define DISTRHO_PLUGIN_CLAP_ID "studio.kx.distrho.examples.imguidemo"
