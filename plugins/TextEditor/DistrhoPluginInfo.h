 ...
 */
#define DISTRHO_PLUGIN_NAME "Text Editor"
...
/**
   ...
   @note This macro is required.
 */
#define DISTRHO_PLUGIN_URI "urn:distrho:examples:texteditor"
...
*/
#define DISTRHO_PLUGIN_CLAP_ID "studio.kx.distrho.examples.texteditor"
